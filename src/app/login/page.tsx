...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (result.success) {
      toast("success", "Login successful!", "Welcome back to Salman Trading.");
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4 py-12 relative">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Portal Login &bull; Salman Trading</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl">
          ...
          <div className="mt-6">
            ...
            <button
              type="button"
              onClick={googleLogin}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-700 rounded-xl text-slate-300 hover:bg-slate-800 transition-colors"
            >
